...
const defaultBranches: BranchData[] = [
    {
        ...
        phone: [
            ...
            {name: "Secretary / HMO", number: "(02) 8461 3890"},
    ...
    },
    {
        ...
        phone: [
            {name: "Reception", number: "(02) 8986 1966 / 8373 2099"},
            {name: "Secretary / HMO", number: "(02) 8983 1968"},
            {name: "Cashier (Smart)", number: "(+63) 998 989 9178"},
            {name: "Inquiry (Sun)", number: "(+63) 925 740 8744"},
            {name: "Inquiry (Globe)", number: "(+63) 917 558 4426"},
        ],
        officeHours: [
            {day: "Monday to Saturday", time: "7:00AM to 4:00PM"},
    ...
    },
    {
        ...
        phone: [
            {name: "Reception", number: "(02) 8636 6291 / 8635 5918"},
            {name: "Secretary / HMO", number: "(02) 8789 0124"},
            {name: "Cashier", number: "(02) 8584 5986"},
            {name: "Inquiry (Smart)", number: "(+63) 998 973 0305"},
            {name: "Inquiry (Globe)", number: "(+63) 917 133 6276"},
        ],
        officeHours: [
            {day: "Monday to Saturday", time: "7:00AM to 4:00PM"},
            {day: "Sunday", time: "Closed"},
